...
export function orderSoftwareToClient(data) {
  const items = data.ecu.map(line => {
    return `
<tr>
  <td>${line.name}</td>
</tr>`;
...
<html xmlns='http://www.w3.org/1999/xhtml'>
  <head>
    ...
    .button--green {
      ...
      border-top: 10px solid #C70909;
      border-right: 18px solid #C70909;
  ...
  <body>
    <span class='preheader'>This is an invoice for your request ${data.orderId}</span>
                  ...
                  <tr>
                    <td class='content-cell'>
                      <div class='f-fallback'>
                        <h1>Hi ${data.name},</h1>
                        <p>Thanks you for trusting TVS GROUP INTERNATIONAL. This is a notification for your recent order software request.</p>
                        ...
                        <table class='purchase' width='100%' cellpadding='0' cellspacing='0'>
                          <tr>
                            <td>
                              <h3> Number Order: ${data.orderId}</h3>
                            </td>
                            <td>
                              <h3 class='align-right'> Date Order: ${moment(data.date).format('MMMM Do YYYY')}</h3>
                            </td>
                          </tr>
                        </table>
                ...
                <table class='email-footer' align='center' width='570' cellpadding='0' cellspacing='0' role='presentation'>
                  <tr>
                    <td class='content-cell' align='center'>
                      <p class='f-fallback sub align-center'>&copy; 2021 TVS GROUP INTERNATIONAL. All rights reserved.</p>
                    </td>
                  </tr>
                </table>
              </td>
