export function customSoftware(data) {
...
<!--                <a href="#" class="f-fallback email-masthead_name" style="color: #C70909; font-size: 20px "> TVS GROUP INTERNATIONAL</a>-->
            ...
            <tr>
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi ${data.name},</h1>
                        <p>Thanks you for trusting TVS GROUP INTERNATIONAL. This is an invoice for your recent custom order software request.</p>
              ...
              <strong>Amount Due:</strong>  ${data.amount}
            </span>
                                  </td>
                                </tr>
                                <tr>
...
<!--              <strong>Due By:</strong> {{due_date}}-->
                        ...
                        <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td>
                              <h3> Number Order: ${data.numberOrder}</h3>
                            </td>
                            <td>
                              <h3 class="align-right"> Date Order: ${data.date}</h3>
                            </td>
                          </tr>
                          <tr>
                            <td colspan="2">
                              <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td>
                                   DEALER CUSTOM SOFTWARE REQUEST FORM
                                  </td>
                                  <td> ${data.amount}</td>
                                 </tr>
...
<!--                                {{/each}}-->
                                <tr>
                                  ...
                                  <td width="20%" class="purchase_footer" valign="middle">
                                    <p class="f-fallback purchase_total"> ${data.amount}</p>
                                  </td>
                                </tr>
                              </table>
                            </td>
